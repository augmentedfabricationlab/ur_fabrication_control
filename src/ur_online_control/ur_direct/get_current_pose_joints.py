...
script += "\tcurrent_pose = get_joint_positions()\n"
script += "\ttextmsg(current_pose)\n"
script += "\tsocket_send_string([current_pose[0], current_pose[1], current_pose[2], current_pose[3], current_pose[4], current_pose[5]])\n"
script += "\tsocket_close()\n"
